  ...
  return (
    <div className="relative rounded-xl overflow-hidden bg-[#15191c]">
      ...
      <div
        ...
        className="touch-pan-y select-none group/card relative bg-surface-gradient border border-[#272d32] rounded-l-xl transition-[border-color,box-shadow] hover:border-[#3a4147] hover:shadow-card"
      >
